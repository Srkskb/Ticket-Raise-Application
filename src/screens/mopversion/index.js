...
export default function Mosversion({ navigation }) {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={style.icimgview}>
                ...
                <Text style={style.styletexthome}>Operating System Version</Text>
            </View>
            <View style={{ flex: 1, }}>
            <ScrollView>
                ...
                <View style={style.addview}>
                    <ScrollView>
                        <View style={style.addnewtextview}>
                            <Text style={style.textadd}>Add New Operating System Version</Text>
                        </View>
                ...
                <View style={style.allviewversion}>
                    <ScrollView>
                        <View style={style.addnewtextview}>
                            <Text style={style.textadd}>All Operating System Version</Text>
                        </View>
                        ...
                        <View style={style.versionnameview}>
                            <Text style={style.versiontextname}>Operating System Version :</Text>
