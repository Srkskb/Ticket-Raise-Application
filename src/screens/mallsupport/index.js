...
class Mallsupport extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            memail: '',
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={style.icimgview}>
                    ...
                    <Text style={style.styletexthome}>All Support Team</Text>
                </View>
                <View style={{ flex: 1, }}>
                    ...
                    <View style={style.allviewversion}>
                        <ScrollView>
                            ...
                            <View style={style.versionnameview}>
                                <Text style={style.versiontextname}>Team manager :</Text>
                            ...
                            <View style={style.Actionbtnmainview}>
                                ...
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('Meditsupport')} style={style.btnviewedit}>
