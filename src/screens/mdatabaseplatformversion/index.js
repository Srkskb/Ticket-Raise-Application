...
export default function Mdatabaseplatformversion({ navigation }) {
...
const VersionList =()=>{
    ...
    fetch("https://bus.kibtechnologies.com/tickets-crm/api/V1/MasterSetupGET/?type=MS3", requestOptions)
      .then(response => response.json())
      .then(result => {
        console.log(result)
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={style.icimgview}>
                ...
                <Text style={style.styletexthome}>Database Platform Version</Text>
            </View>
            <View style={{ flex: 1, }}>
                 <ScrollView>
                ...
                <View style={style.addview}>
                    <ScrollView>
                        <View style={style.addnewtextview}>
                            <Text style={style.textadd}>Add New Database Platform Version</Text>
                        </View>
      ...
      <Text style={style.textallselect}>Products</Text>
                ...
                <View style={style.allviewversion}>
                    <ScrollView>
                        <View style={style.addnewtextview}>
                            <Text style={style.textadd}>All Database Platform Version</Text>
                        </View>
                        </ScrollView>
                </View>
