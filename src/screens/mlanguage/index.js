                    ...
                    <ScrollView>
                        ...
                        <View style={{marginLeft:20}}>
                           ...
                           <View style={style.versionvalueview}>
                                <Text style={style.textallselect}>Language</Text>
                ...
                <View style={style.allviewversion}>
                    <ScrollView>
                        ...
                        <View style={style.versionnameview}>
                            <Text style={style.versiontextname}>Language Name :</Text>
                            <Text style={style.versionnumtext}>  English</Text>
                            <Text style={style.versionnumtext}>  Hindi</Text>
