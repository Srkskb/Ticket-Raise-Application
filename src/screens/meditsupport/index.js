...
export default function Meditsupport({ navigation }) {
    ...
    const goBack = () => {
        navigation.navigate('Mallsupport')
    };
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={style.icimgview}>
                ...
                <Text style={style.styletexthome}>Edit Support Team</Text>
            </View>
            <View style={{ flex: 1, }}>
                <ScrollView style={{ marginLeft: 30 }}>
                    ...
                    <View>
                        <Text style={style.textallselect}>Select Manager Name</Text>
                        <Picker
                            style={style.pickerview}
                            selectedValue={issmname}
                            onValueChange={(itemValue) =>
                                setsmname(itemValue)
                            }>
                            <Picker.Item label="Select one" value="Select one" />
                            <Picker.Item label="Rohit Chauhan" value="Rohit Chauhan" />
                        </Picker>
                    </View>
                    ...
                    <View>
                        ...
                        <View style={style.checkboxContainer}>
                            <CheckBox
                                ...
                                style={style.checkbox}
                            />
                            <Text style={style.labeltext}> Products</Text>
                        </View>
                        <View style={style.checkboxContainer}>
                            <CheckBox
                                value={isService}
                    ...
                    <View>
                        ...
                        <View style={style.checkboxContainer}>
                            <CheckBox
                                ...
                                style={style.checkbox}
                            />
                            <Text style={style.labeltext}> Forgot password option</Text>
                        </View>
