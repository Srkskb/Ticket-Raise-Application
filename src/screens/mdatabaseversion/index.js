...
import FileCabin from '../../Components/FileCabin';
...
const VersionList =()=>{
    ...
    fetch("https://bus.kibtechnologies.com/tickets-crm/api/V1/MasterSetupGET/?type=MS2", requestOptions)
      .then(response => response.json())
      .then(result =>{ 
        console.log(result)
                ...
                <View style={style.addview}>
                    <ScrollView>
                        <View style={style.addnewtextview}>
                            <Text style={style.textadd}>Add New Database Version</Text>
                        </View>
