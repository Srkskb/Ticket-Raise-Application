...
class Register extends React.Component {
  ...
  signin() {
    console.log('Show enter', this.props.navigation);
  ...
  render() {
    let {iseye, visible, iseyeone, visibleone, showPop} = this.state;
          ...
          <Animatable.View
            ...
            <View
              ...
              <Text
                ...
                Signup Success, Welcome to YogiX
              </Text>
              <View
                style={{
                  flexDirection: 'row',
        ...
        <View style={style.secview}>
          ...
          <ScrollView>
            <View style={style.flexpass}>
              <TextInput
                placeholder="Enter Company CSR No"
                placeholderTextColor={Colors.colorred}
            ...
            <View style={{}}>
              ...
              <TouchableOpacity
                ...
                // onPress={() => this.setState({showPop: true})}
