...
class Muserrequest extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            memail: '',
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={style.icimgview}>
                    ...
                    <Text style={style.styletexthome}>All User Request</Text>
                </View>
                <View style={{ flex: 1, }}>
                        ...
                        <ScrollView>
                            ...
                            <View style={style.Actionbtnmainview}>
                                ...
                                <TouchableOpacity style={style.btnviewtest}>
                                    <Text style={style.textadd}>In Active</Text>
                                </TouchableOpacity>
                            </View>
